...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: '另一空间的昼夜流转。',
    description:
      '同主题的第二组场景练习，重点研究不同建筑/植被构图下，光线随时间变化时的色温、阴影长度与剪影关系。资产来自 FAB。',
    category: 'lighting',
    year: 2025,
  ...
  },
  {
    ...
    tagline: '一帧时刻。',
    description:
      '单帧氛围练习，专注于一个最具代表性的时刻，研究剪影、轮廓光与大气透视在画面中的层次安排。资产来自 FAB。',
    category: 'lighting',
    year: 2025,
  ...
  },
  {
    ...
    tagline: '同一空间，不同情绪。',
    description:
      '在固定场景资产下，探索从冷色科幻、暖色叙事到戏剧化夜景等多种灯光风格，研究色温、对比、Key/Fill/Rim 三段式布光在同一构图下的情绪差异。',
    category: 'relight',
    year: 2025,
    cover: bg('relight-03.png'),
    surface: 'dark-2',
    gallery: [
      bg('relight-01.png'),
      bg('relight-02.png'),
